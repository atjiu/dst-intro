...
**获取：**
- 装备解锁后的钓鱼证书钓淡水鱼，查理会出现给予待完成的渔夫证书
...
**获取：**
- 装备解锁后的开荒证书锄地，查理会出现给予待完成的农业证书

**考验内容：**
- 收获17种\`自己种的\`巨大作物（官方14种作物+模组内的3种）
...
**获取：**
- 非鱼妹玩家跟鱼人王交易时，查理会出现给予待完成的鱼人王任命书
...
**获取：**
- 将牛铃与牛建立联系时，查理会出现给予待完成的驯兽师证书

**考验内容：**
- 将**自己的牛**完全驯化（完全驯化时确保牛铃戴在身上）
...
- 走在蜘蛛丝上不再减速
      ...
      {
        name: "养蜂证书",
        image: "certificate_bee.png",
        code: "certificate_bee",
        description: `
> 注：装备前要使用羽毛笔签上自己的名字

**获取：**
- 吃蜂蜜或蜜汁火腿时，查理会出现给予养蜂证书
...
|9.375|-10|-8||
      ...
      {
        name: "烤灯笼椒",
        image: "cer_bellpepper_cooked.png",
        code: "cer_bellpepper_cooked",
        foodtype: "VEGGIE",
        fresh: "20天",
        description: `
|饱|精|血|其它|
...
|18.75|15|3|收获x2|
      ...
      {
        name: "青辣椒炒红辣椒",
        image: "cer_doublepepper.png",
        code: "cer_doublepepper",
        foodtype: "好东西",
        fresh: "15天",
        description: `
> 江西
...
|37.5|33|8||
      ...
      {
        name: "生煎",
        image: "cer_panfriedbuns.png",
        code: "cer_panfriedbuns",
        foodtype: "好东西",
        fresh: "10天",
        description: `
> 上海
...
3个生姜研磨成2个生姜粉，给料理调味，吃后半天保暖
      ...
      {
        name: "齿轮粉",
        image: "spice_cer_gears.png",
        code: "spice_cer_gears",
        description: `
...
走在上面加速与石砖路一样
      ...
      {
        name: "黄金墙",
        image: "wall_cer_cutgold.png",
        tech: "二本",
        recipe: "金砖*2",
        code: "wall_cer_cutgold_item",
        description: `
金钱的味道
            `,
      },
...
电气化电路扫描对象更换为亮茄
      ...
      },
      {
        ...
        description: `
移除了食人花、巨大作物、贝壳堆、沉底宝箱、疙瘩树种子、恶液储存箱的碰撞体积
            `,
      },
      {
        name: "浇水壶",
